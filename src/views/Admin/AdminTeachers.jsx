      ...
      <div className={classes.root}>
        <Card>
          <CardHeader style={{backgroundColor:"#00a1ff"}}>
            <h4 className={classes.cardTitleWhite} style={{color:'#FFFFFF'}}>Teacher's Accounts</h4>
...
export default withStyles(styles, { withTheme: true })(AdminTeachers);
/*

              data={this.state.search ? this.state.accounts.filter(
                x => x[this.state.searchBy].includes(this.state.search)) : this.state.accounts }
                
 <div>
                      {this.state.search ? (
                        <div>
                        {prop[this.state.searchBy].includes(this.state.search) ? (
                          <TableRow key={key}>
                        <TableCell style={{ backgroundColor: backColor }} className={classes.tableCell}>{prop.userID}</TableCell>
                        <TableCell style={{ backgroundColor: backColor }} className={classes.tableCell}>{prop.name}</TableCell>
                        <TableCell style={{ backgroundColor: backColor }} className={classes.tableCell}>{prop.lastName}</TableCell>
...
<Card>
          <CardHeader color="primary">
            <h4 className={classes.cardTitleWhite}>Teacher's Account</h4>
            <p className={classes.cardCategoryWhite}>
              All teacher's account that are Activated
            </p>
          </CardHeader>
          <CardBody>
            <Table
